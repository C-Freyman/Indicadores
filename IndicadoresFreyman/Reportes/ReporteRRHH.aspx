        ...
        <telerik:RadGrid RenderMode="Lightweight" ID="RadGridRRHH" runat="server" CellSpacing="0" CellPadding="0" Font-Size="Smaller" Width="70%" Style="padding: 0; margin: 0 auto"
            ...
            <MasterTableView AutoGenerateColumns="false" ShowFooter="false" AllowFilteringByColumn="false" CellPadding="0" CellSpacing="0">
                <Columns>
                    ...
                    <telerik:GridBoundColumn FilterControlWidth='80%' HeaderStyle-Width='150' DataField='codigoempleado' SortExpression="codigoempleado" HeaderText='Código empleado' ItemStyle-HorizontalAlign="left" AutoPostBackOnFilter="true" CurrentFilterFunction="EqualTo" ShowFilterIcon='false'></telerik:GridBoundColumn>
